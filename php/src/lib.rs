...
pub type SuccessCallback = unsafe extern "C" fn(isize, *const c_char) -> ();
pub type FailureCallback = unsafe extern "C" fn(isize) -> ();
...
fn create_connection_request(
    ...
    println!("create_connection_request");
...
fn create_client_internal(
    ...
    logger_core::log(logger_core::Level::Info, "php-lib", "hello");
    ...
    let runtime = Builder::new_multi_thread()
        .enable_all()
        .thread_name("GLIDE for Redis PHP thread")
        .build()?;
...
pub extern "C" fn get(
    ...
    client.runtime.spawn(async move {
        ...
        let from_value = Option::<CString>::from_owned_redis_value(value);
        println!("{:?}", from_value);
